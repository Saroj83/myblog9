...
public class PostController {
    ...
    //Delete the record and sending Response to the postman using ResponseEntity
    @PreAuthorize("hasRole('ADMIN')")
    @DeleteMapping("/{id}")
    ...
    //Getting All the record from db in form of Pagination format and sorting by title , ascending and descending order
